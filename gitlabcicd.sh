...
#
#********START USER_INPUTS*********
TESTSIGMA_API_KEY=eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJiYWQ4YTNkOS0yY2FlLTQxNmItYmJjMC05MjAyOWJhNzk0NmMiLCJkb21haW4iOiJ0ZXN0c2lnbWF0ZWNoLmNvbSIsInRlbmFudElkIjoyODE3fQ.8XGSq8o-ka6IPMHllmD6_qsx5L5tkINXykn5px51TD7UFngCug_xwiZtbKqmm2IUGPvC0rSUlUw0ZzuRMUSBKg
MAX_WAIT_TIME_FOR_SCRIPT_TO_EXIT=60
JUNIT_REPORT_FILE_PATH=./junit-report-$(date +"%Y%m%d%H%M").xml
BUILD_NO=$(date +"%Y%m%d%H%M")
TESTSIGMA_TEST_PLAN_ID=784
#********END USER_INPUTS***********
