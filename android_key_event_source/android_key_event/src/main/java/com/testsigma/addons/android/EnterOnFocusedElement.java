...
@Action(actionText = "Enter testdata on focused element using keypad", applicationType = ApplicationType.ANDROID)
public class EnterOnFocusedElement extends AndroidAction {
